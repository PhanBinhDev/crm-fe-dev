  ...
  const handleSubmit = async (values: any) => {
    try {
      const transformedValues = {
        ...
        role: values.role,
        phone: values.phone || null, // Giữ nguyên null cho phone
        dateOfBirth: values.dateOfBirth || undefined, // Hoàn tác về undefined
        avatar: values.avatar || undefined, // Hoàn tác về undefined
      };
    ...
    >
      <Form.Item
        ...
        rules={[
          ...
          { pattern: /^[0-9]{10,11}$/, message: 'Số điện thoại không hợp lệ. Vui lòng nhập số điện thoại hợp lệ (chỉ bao gồm số, 10 hoặc 11 chữ số).' },
        ]}
      >
